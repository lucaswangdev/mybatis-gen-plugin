...
import com.lucaswangdev.mybatis.generator.dao.MetaDataDao;
...
public class Generator {
	...
	private void generate(File templateEntry, Database database, GenerateSetting setting){
		TemplateProcessor processor = new TemplateProcessor(setting, templateEntry, database, logger, setting.getJavaDelimiter(), setting.getXmlDelimiter());
		processor.process();;
