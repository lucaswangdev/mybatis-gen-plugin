package com.lucaswangdev.mybatis.generator.settings;
...
public class GenerateSetting {
    ...
    public static GenerateSetting getInstance(Properties properties){
        ...
        setting.javaDelimiter = properties.getProperty("javaDelimiter");
        setting.xmlDelimiter = properties.getProperty("xmlDelimiter");
...
//                    }
    ...
    public String getXmlDelimiter() {
        return StringUtils.isBlank(xmlDelimiter) ? "<!-- 以上部分由插件生成请勿修改 -->" : xmlDelimiter;
    }
}
